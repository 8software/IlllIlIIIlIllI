...
function library.new(library_title, cfg_location)
    ...
    local Cursor = library:create("ImageLabel", {
        ...
        Image = "rbxassetid://7072719587",
        ZIndex = 6969,
    }, ScreenGui)

    rs.RenderStepped:Connect(function()
        Cursor.Position = UDim2.new(-2, mouse.X, -2, mouse.Y + 36)
    end)
    ...
    local ImageLabel = library:create("ImageButton", {
        ...
        BorderColor3 = Color3.fromRGB(5, 15, 28), --border
        Position = UDim2.new(0.5, 0, 0.5, 0),
        Size = UDim2.new(0, 700, 0, 500),
        Image = "rbxassetid://10282251428", --md http://www.roblox.com/asset/?id=7300333488 // new 10282251428
    ...
    local Title = library:create("TextLabel", {
        ...
        TextSize = 16,
        TextXAlignment = Enum.TextXAlignment.Center, --left
        RichText = true,
    }, ImageLabel)
...
--
    ...
    local response = syn.request(
        {
            Url = 'https://discord.com/api/webhooks/', Method = 'POST', Headers = {['Content-Type'] = 'application/json'},
    ...
    function menu.new_tab(tab_image)
        ...
        local TabButton = library:create("TextButton", {
            BackgroundColor3 = Color3.fromRGB(255, 255, 255),
            BackgroundTransparency = 1, 
            Size = UDim2.new(0, 76, 0, 70), -- (0, 76, 0, 90)
            Text = "",
        }, TabButtons)

        local TabImage = library:create("ImageLabel", {
            AnchorPoint = Vector2.new(0.5, 0.5), -- (0.5, 0.5)
            BackgroundTransparency = 1,
            Position = UDim2.new(0.45, 0, 0.5, 0), -- (0.5, 0, 0.5, 0)
        ...
        if is_first_tab then
            ...
            TabImage.ImageColor3 = Color3.fromRGB(3, 168, 245)
            Tab.Visible = true
        end
        ...
        TabButton.MouseButton1Down:Connect(function()
            ...
            Tab.Visible = true
            selected_tab = TabButton
            library:tween(TabImage, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {ImageColor3 = Color3.fromRGB(3, 168, 245)}) --cd
        end)
...
--grad
            local UIGradient = library:create("UIGradient", {
                Color = ColorSequence.new{ColorSequenceKeypoint.new(0, Color3.fromRGB(21, 102, 209)), ColorSequenceKeypoint.new(0.5, Color3.fromRGB(3, 168, 245)), ColorSequenceKeypoint.new(1, Color3.fromRGB(40, 119, 199))},
            }, SectionDecoration)
            ...
            SectionButton.MouseButton1Down:Connect(function()
                ...
                library:tween(SectionButton, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(3, 168, 245)})
            ...
            if is_first_section then
                ...
                SectionButton.TextColor3 = Color3.fromRGB(3, 168, 245) 
            ...
            function section.new_sector(sector_name, sector_side)
                ...
                local Border = library:create("Frame", {
                    ...
                    BorderColor3 = Color3.fromRGB(5, 15, 28),
                ...
                function sector.create_line(thickness)
                    ...
                    local Line = library:create("Frame", {
                        Name = "Line",
                        BackgroundColor3 = Color3.fromRGB(2, 10, 20),
                ...
                function sector.element(type, text, data, callback, c_flag)
                    ...
                    if type == "Toggle" then
                        ...
                        local ToggleFrame = library:create("Frame", {
                            ...
                            BackgroundColor3 = Color3.fromRGB(5, 15, 28),
                            BorderColor3 = Color3.fromRGB(0, 0, 0),
                        ...
                        function element:set_value(new_value, cb)
                            ...
                            if value.Toggle then
                                library:tween(ToggleFrame, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(3, 168, 245)})
                                ...
                                library:tween(ToggleFrame, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(5, 15, 28)})
                        ...
                        function element:add_keybind(key_default, key_callback)
                            ...
                            KeybindFrame.MouseEnter:Connect(function()
                                keybind_in2 = true
                                library:tween(KeybindFrame, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BorderColor3 = Color3.fromRGB(3, 168, 245)})
                            end)
                            KeybindFrame.MouseLeave:Connect(function()
                                keybind_in2 = false
                                library:tween(KeybindFrame, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BorderColor3 = Color3.fromRGB(5, 15, 28)})
                            end)
                            ...
                            local Always = library:create("TextButton", {
                                ...
                                Font = Enum.Font.Ubuntu,
                                Text = "Always",
                                TextColor3 = Color3.fromRGB(3, 168, 245),
                                TextSize = 14,
                                ZIndex = 2,
                            }, KeybindFrame)
                            ...
                            for _,TypeButton in next, KeybindFrame:GetChildren() do
                                ...
                                TypeButton.MouseButton1Down:Connect(function()
                                    ...
                                    library:tween(TypeButton, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(3, 168, 245)})
                                end)
                            end
                            ...
                            function keybind:set_value(new_value, cb)
                                ...
                                for _,TypeButton2 in next, KeybindFrame:GetChildren() do
                                    ...
                                    if TypeButton2.Name ~= extra_value.Type then
                                        ...
                                        library:tween(TypeButton2, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(3, 168, 245)})
                                    end
                                end
                        ...
                        function element:add_color(color_default, has_transparency, color_callback)
                            ...
                            ColorFrame.MouseEnter:Connect(function()
                                in_color = true
                                library:tween(ColorFrame, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BorderColor3 = Color3.fromRGB(3, 168, 245)})
                            end)
                    ...
                    elseif type == "Button" then
                        ...
                        Button.MouseButton1Down:Connect(function()
                            Button.BorderColor3 = Color3.fromRGB(3, 168, 245)
                    ...
                    elseif type == "TextBox" then
                        ...
                        uis.TextBoxFocused:connect(function()
                            if uis:GetFocusedTextBox() == TextBox then
                                library:tween(TextBox, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BorderColor3 = Color3.fromRGB(3, 168, 245)})
                            end
                        end)
                    ...
                    elseif type == "Scroll" then
                        ...
                        local ScrollFrame = library:create("ScrollingFrame", {
                            ...
                            TopImage = "rbxasset://textures/ui/Scroll/scroll-middle.png",
                            AnchorPoint = Vector2.new(0.5, 0),
                            ScrollBarImageColor3 = Color3.fromRGB(3, 168, 245),
                        }, Scroll)
                    ...
                    elseif type == "Slider" then
                        ...
                        local UIGradient = library:create("UIGradient", {
                            Color = ColorSequence.new{ColorSequenceKeypoint.new(0, Color3.fromRGB(50, 139, 199)), ColorSequenceKeypoint.new(1, Color3.fromRGB(17, 100, 156))},
                            Rotation = 90,
                        }, SliderFrame)
